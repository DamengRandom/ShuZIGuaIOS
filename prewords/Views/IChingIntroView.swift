    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                Text("易经简介").font(.title).padding(.vertical)
                
                Text("《周易》即为《易经》，《三易》之一，传说是周文王姬昌所作，内容包括《经》和《传》两个部分 。《经》主要是 64 卦和 384 爻，卦和爻各有说明（卦辞与爻辞），作为占卜之用。《周易》没有提出阴阳与太极等概念，讲阴阳与太极的是被道家与阴阳家所影响的《易传》。《传》包含解释卦辞和爻辞的七种文辞共十篇，统称《十翼》，相传为孔子所撰。").padding(.vertical, 4)
